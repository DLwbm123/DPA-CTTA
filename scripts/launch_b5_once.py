...
env=os.environ.copy();env.pop('CUBLAS_WORKSPACE_CONFIG',None);env.update(CUDA_VISIBLE_DEVICES=r['gpu_uuid'],RUN_FILE=str(code/'scripts/run_b5.py'))
...
try:
    ...
    result.update(status='B5_RUN_RECOMPUTE_REPORT_COMPLETE',exit_code=0)
