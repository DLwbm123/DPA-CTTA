...
suite=unittest.TestSuite([unittest.TestLoader().loadTestsFromName('test_b5'),unittest.TestLoader().loadTestsFromName('test_b4.Checks.test_weak_mean_detach_RGB_normalization_and_no_mutation')]);result=unittest.TextTestRunner(verbosity=2).run(suite)
