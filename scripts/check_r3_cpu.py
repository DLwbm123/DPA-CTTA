...
modules=['test_r3_reference','test_r3','test_r3_execution']
if os.environ.get('R3_EXECUTION_ONLY')=='1':modules=['test_r3_execution']
if os.environ.get('R3_FINAL_FOCUSED')=='1':modules=['test_r3.HostTests.test_S_host_switch_does_not_replay_augmentation_or_copy_model','test_r3_execution']
if os.environ.get('R3_REGRESSION')=='1':modules+=['test_r1','test_r1_fixes','test_r2','test_r2_continuation']
