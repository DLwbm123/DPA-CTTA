...
modules=['test_r6_loss','test_r6_host','test_r6_execution','test_r6_analysis','test_r5_rule','test_r5_host','test_r5_analysis','test_r5_audit_fix']
if os.environ.get('R6_MODULES'):modules=os.environ['R6_MODULES'].split(',')
